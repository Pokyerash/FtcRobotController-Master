...
@com.qualcomm.robotcore.eventloop.opmode.Autonomous (name ="RC")
public class RC extends LinearOpMode {
    ...
    private void right() {
        ...
        encoderDrive(DRIVE_SPEED, 1, -1, 5000);
        sleep(400);
    ...
    private void center() {
        encoderDrive(DRIVE_SPEED, -5.3, 5.3, 5000);
        sleep(300);

        SUD.setPosition(0.30);
        sleep(300);
        CD.setPosition(0.5);
        sleep(200);
        encoderDrive(DRIVE_SPEED, -5.6, -5.6, 5000);
        ...
        encoderDrive(DRIVE_SPEED, -8.5, 8.5, 5000);
    ...
    private void left() {
        ...
        encoderDrive(DRIVE_SPEED, 5.6, 5.6, 5000);
        encoderDrive(DRIVE_SPEED, -0.4, 0.4, 5000);
        sleep(300);
        ...
        encoderDrive(DRIVE_SPEED, 0.55, -0.55, 5000);
        ...
        encoderDrive(DRIVE_SPEED, -8.6, 8.6, 5000);
