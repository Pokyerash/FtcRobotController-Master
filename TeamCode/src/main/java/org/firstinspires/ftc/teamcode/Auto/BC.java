...
@com.qualcomm.robotcore.eventloop.opmode.Autonomous (name ="BC")
public class BC extends LinearOpMode {
    ...
    private void right() {
        encoderDrive(DRIVE_SPEED, -6.8, 6.8, 5000);
    ...
    private void center() {
        ...
        encoderDrive(DRIVE_SPEED, -5.2, 5.2, 5000);
        sleep(200);
        SUD.setPosition(0.2);
        ...
        encoderDrive(DRIVE_SPEED, -8.9, 8.9, 5000);
    ...
    private void left() {
        ...
        encoderDrive(DRIVE_SPEED, 5.5, 5.5, 5000);
        encoderDrive(DRIVE_SPEED, 0.7, -0.7, 5000);
        sleep(200);
