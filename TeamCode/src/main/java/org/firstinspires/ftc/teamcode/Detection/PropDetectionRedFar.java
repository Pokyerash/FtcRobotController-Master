...
public class  PropDetectionRedFar implements VisionProcessor {
    ...
    //dreapta
    public static int rightRectX1 = 900, rightRectY1 = 350;
    public static int rightRectX2 = 1050, rightRectY2 = 500;

    public static double rightThresh = 400000;
    public double rightSum = 0;
    //centru
    public static int middleRectX1 = 400, middleRectY1 = 350;
    public static int middleRectX2 = 550, middleRectY2 = 500;
