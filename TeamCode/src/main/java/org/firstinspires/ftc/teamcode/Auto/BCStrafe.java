...
@com.qualcomm.robotcore.eventloop.opmode.Autonomous (name ="BCStrafe")
public class BCStrafe extends LinearOpMode {
    ...
    private void right() {
        ...
        encoderDrive(DRIVE_SPEED, -11, -11, 5000);
    ...
    private void center() {
        ...
        encoderDrive(DRIVE_SPEED, -6.2, 6.2, 5000);
        sleep(200);
        SUD.setPosition(0.2);
